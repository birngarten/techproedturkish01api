...
public class PatchRequest01 extends TestBase{
	...
	public void patch01() {
		...
		jsonObject.put("title", "Irfan Ruhi");
		Response responseAfterPatch = given().
										contentType(ContentType.JSON).
										spec(spec03).
										body(jsonObject.toString()).
									when().
										patch("/200"); //patch kullanirken hem body hem de patch'in data'si olmali
...
//		title'i hard assertion yapalim
		assertEquals(jsonObject.get("title"),json.get("title")); //jsonObject.get("title") dinamik code
